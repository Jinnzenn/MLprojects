...
X, mu, sigma = feature_normalize(X)  # 返回特征缩放后的数据、每列均值、每列标准差
...
# ==========================================================
print('Predicted price of a 1650 sq-ft, 3 br house (using gradient descent) : {:0.3f}'.format(price)) //这个语法像是C语言的
...
x2=np.array([1,1650,3])  # theta_0偏置,面积的theta_1，房间的theta_2
